        ...
        <div className="cards-grid">
          ...
          <div className="quick-card glass-card">
            ...
            <div className="card-content">
              ...
              <p className="card-val">+92 321 6157018</p>
              <span className="card-sub">Mon–Sat, 9:00 AM – 9:00 PM PKT</span>
              <a href="https://wa.me/923216157018" target="_blank" rel="noopener noreferrer" className="card-action-link">
          ...
          <div className="left-info-column">
            ...
            <div className="social-connect-box glass-card">
              ...
              <div className="social-pills-row">
                ...
                <a href="https://wa.me/923216157018" target="_blank" rel="noopener noreferrer" className="social-pill">
